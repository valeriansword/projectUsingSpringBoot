...
function AddProduct() {
  ...
  const handleSubmit = (event) => {
    ...
    formData.append("product",new Blob([JSON.stringify(product)],{type:"application/json"}))
      ...
      axios.post("http://localhost:8080/products/addProducts",formData,{
          headers:{
  ...
  return (
    <div className="p-4 bg-gray-700 text-black h-screen">
      <div className="w-full flex justify-center">
        <form className=" space-y-4 w-[40%] max-sm:w-[90%] " onSubmit={handleSubmit}>
          <div className="flex ">
